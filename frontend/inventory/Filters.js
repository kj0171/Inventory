    ...
    <div className="filters-container">
      ...
      <div className="filters-grid">
        ...
        <div className="filter-group">
          ...
          <select value={filters.category} onChange={(e) => onFilterChange('category', e.target.value)} className="filter-select">
        ...
        <div className="filter-group">
          ...
          <select value={filters.itemGroup} onChange={(e) => onFilterChange('itemGroup', e.target.value)} className="filter-select">
        ...
        <div className="filter-group">
          ...
          <select value={filters.stockLevel} onChange={(e) => onFilterChange('stockLevel', e.target.value)} className="filter-select">
        ...
        <div className="filter-group">
          ...
          <select value={filters.ageFilter} onChange={(e) => onFilterChange('ageFilter', e.target.value)} className="filter-select">
        ...
        <div className="filter-group">
          ...
          <div className="sort-controls">
            <select value={filters.sortBy} onChange={(e) => onFilterChange('sortBy', e.target.value)} className="filter-select">
