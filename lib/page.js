              ...
              {filteredData.map((row, i) => (
                <div key={i} className="mobile-card">
                  <div className="mobile-card-header">
                    <h3 className="mobile-card-title">{row.inventory_items?.name || 'Unknown Item'}</h3>
                    <span className={`category-badge ${getCategoryClass(row.inventory_items?.item_category)}`}>
                      {row.inventory_items?.item_category || 'Other'}
                    </span>
                  </div>
                  <div className="mobile-card-details">
                    <div className="mobile-card-field">
                      <div className="mobile-card-field-label">Stock Level</div>
                    ...
                    <div className="mobile-card-field">
                      <div className="mobile-card-field-label">Last Updated</div>
                      <div className="mobile-card-field-value">
                        <span className="date-text">
                          {new Date(row.created_at).toLocaleDateString('en-US', {
                            year: 'numeric',
